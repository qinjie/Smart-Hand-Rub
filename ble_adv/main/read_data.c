...
void storeValuesOfProgram(char* storage, char* name1, char* name2, char* name3, char* name4, char* name5 
	...
	if (err != ESP_OK) {
		...
		err = nvs_set_i32(value_handle, name1, value1);
		err = nvs_set_i32(value_handle, name2, value2);
		err = nvs_set_i32(value_handle, name3, value3);
		err = nvs_set_i32(value_handle, name4, value4);
		err = nvs_set_i32(value_handle, name5, value5);
        err = nvs_commit(value_handle);
		nvs_close(value_handle);
	}
}
//Get 5 values of names
void getValuesOfProgram(char* storage, char* name1, char* name2, char* name3, char* name4, char* name5 
	...
	if (err != ESP_OK) {
		...
		err = nvs_get_i32(value_handle, name1, value1);
		err = nvs_get_i32(value_handle, name2, value2);
		err = nvs_get_i32(value_handle, name3, value3);
		err = nvs_get_i32(value_handle, name4, value4);
		err = nvs_get_i32(value_handle, name5, value5);
        /*switch (err) {
            case ESP_OK:
                //printf("Read Serial successfull\n");
                break;
